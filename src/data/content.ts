...
export const portfolioData = {
  ...
  projects: [
    {
      number: "01",
      id: "swaddesh",
      title: "SwadDesh Pre-Launch & Ecosystem",
      subtitle: "Next.js Pre-Launch Portal • Google Sheets Sync & Automated Email Flow",
      ...
      solution:
        "Engineered a high-performance Next.js Pre-Launch web application (swaddesh.in) featuring an interactive interest and opinion capture form. Integrated real-time API streaming to Google Sheets for lead logging and triggered automated transactional confirmation emails ('Thank you for joining SwadDesh') to every user.",
      outcome:
      ...
      metrics: [
        ...
        { label: "Data Logging", value: "Google Sheets API" },
        { label: "Email Pipeline", value: "Automated Triggers" },
        { label: "Live Domain", value: "swaddesh.in" },
      ],
    },
    {
      number: "02",
  ...
  swaddesh: {
    ...
    prelaunch: {
      eyebrow: "06 / PRE-LAUNCH LIVE • NEXT.JS PORTAL",
      badge: "PRE-LAUNCH ACTIVE",
      headline: "SwadDesh Next.js Pre-Launch Portal",
      ...
      highlights: [
        "Built in Next.js & TypeScript with sub-second responsive UX",
        "Interactive Interest & Opinion Form capturing customer food cravings",
        "Real-Time Google Sheets API integration for structured lead logging",
        "Automated 'Thank you for joining SwadDesh' transactional email dispatch",
      ],
      pipeline: [
        {
          step: "01",
          title: "Next.js Interactive Form",
          desc: "Visitors at swaddesh.in share their regional sweet cravings, artisan opinions, and contact info.",
        },
        {
          step: "02",
          title: "Google Sheets Sync",
          desc: "Submissions are instantly streamed and logged into a central Google Spreadsheet database.",
        },
        {
          step: "03",
          title: "Automated Email Trigger",
          desc: "System sends a personalized 'Thank you for joining SwadDesh' welcome email to the respondent.",
        },
      ],
      metrics: [
        { label: "Frontend Engine", value: "Next.js 15" },
        { label: "Form & Feedback", value: "Interest Survey" },
        { label: "Live Data Sync", value: "Google Sheets" },
        { label: "Confirmation", value: "Automated Email" },
      ],
    },
